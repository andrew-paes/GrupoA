...
namespace GrupoA.Sincronizacao
{
    public class ProdutoSincronizador
    {
        ...
        private bool _flagTesteLocal = true;
        ...
        {
            if (produtoBO.RevistaAssinatura != null && produtoBO.RevistaAssinatura.Revista != null && !String.IsNullOrEmpty(produtoBO.RevistaAssinatura.Revista.ISSN))
            {
