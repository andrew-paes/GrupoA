<%@ Page Language="C#" AutoEventWireup="true" CodeFile="noticiaImagens.aspx.cs" Inherits="content_module_noticia_noticiaImagens" %>
        ...
        <div>
            ...
            <div class="divCampo">
                <div>
                    ...
                    ControlToValidate="txtOrdem" ErrorMessage="Aceita somente números" ValidationExpression="^[0-9].*$"></asp:RegularExpressionValidator>    
                </div>
                <div>
