...
public partial class content_module_tituloProduto_tituloProdutoImagem : System.Web.UI.Page
{
    #region Propriedades
    ...
    private void GeraImagens(int idArquivo, string nomeArquivo, int id)
    {
        if (Page.IsValid)
        {
            if (idArquivo > 0)
            {
                ...
                string strFilePath = Server.MapPath(string.Concat(GrupoA_Resource.baseUrlUpload, "/", "imagensTitulo", "/"));
                ...
                //File.Copy(strFileName, strFilePath + strFileNameG, true);
                ...
                //GeradorDeImagemThumb.GerarProporcao(strFilePath + strFileNameG, 330, 440,
