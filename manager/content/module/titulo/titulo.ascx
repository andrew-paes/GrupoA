<%@ Control Language="C#" AutoEventWireup="true" CodeFile="titulo.ascx.cs" Inherits="content_module_titulo_titulo" %>
...
<br />
<br />
<asp:Label runat="server" ID="Label6" Font-Bold="true" Text="Sub-Título:"></asp:Label>
...
<br />
<asp:TextBox ID="txtResumo" Width="350px" CssClass="frmborder" 
	...
	<table cellpadding="5" cellspacing="5">
		<tr>
			<td>
                ...
                <br /><asp:Label ID="lblPaginas" runat="server" CssClass="frmborder" 
                    Width="200px"></asp:Label>
            </td>
		    <td>
                <asp:Label ID="Label40" runat="server" Font-Bold="true" Text="Edição:"></asp:Label>
                <br /><asp:Label ID="lblEdicao" runat="server" CssClass="frmborder" Text="" 
                    Width="200px"></asp:Label>
            </td>
        </tr>
		<tr>
            <td>
                ...
                <br /><asp:Label ID="lblDtLancamento" runat="server" CssClass="frmborder" Text="" 
                    Width="200px"></asp:Label>
            </td>
            <td>
                <asp:Label ID="Label2" runat="server" Font-Bold="true" Text="ISBN 10:"></asp:Label>
                <br /><asp:Label ID="lblISBN10" runat="server" CssClass="frmborder" Text="" 
                    Width="200px"></asp:Label>
        ...
        <tr>
            <td>
                ...
                <br /><asp:Label ID="lblISBN13" runat="server" CssClass="frmborder" Text="" 
                    Width="200px"></asp:Label>
        ...
        <tr>
			<td colspan="2">
                ...
                <br /><asp:TextBox ID="txtFormato" runat="server" CssClass="frmborder" 
        ...
        <tr>
            <td>
                <asp:CheckBox ID="chkDisponivel" runat="server" Text="Disponivel" Enabled="false" />
            </td>
            <td>
        ...
        <tr>
            <td colspan="2">
                <asp:CheckBox ID="chkHomologado" runat="server" Text="Homologado" Enabled="false" />
            </td>
        </tr>
		</table>
</asp:Panel>
...
<ag2:ListFiles ID="ListFiles1" runat="server" TargetFolder="imagensTitulo/" Editable="true"
    MaxFileLength="5000" ScriptModal="tituloImagens.aspx" MultiFile="true" TipoArquivo="ALL"/>
<!-- Controles -->
<br />
