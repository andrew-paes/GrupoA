<%@ Page Language="C#" AutoEventWireup="true" CodeFile="revistaArtigoImagens.aspx.cs" Inherits="content_module_revistaArtigo_revistaArtigoImagens" %>
...
<%--            <div class="divCampo">
                <div>
                    Ordem
                    <asp:RequiredFieldValidator ID="rfvOrdem" runat="server" Display="Dynamic" ControlToValidate="txtOrdem"
                        ErrorMessage="Campo Obrigatório"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ControlToValidate="txtOrdem" Display="Dynamic" ErrorMessage="Aceita somente números" ValidationExpression="^[0-9].*$"></asp:RegularExpressionValidator>    
                </div>
                <div>
                    <asp:TextBox ID="txtOrdem" CssClass="frmborder" runat="server"  MaxLength="3"/>
                </div>
            </div>--%>
