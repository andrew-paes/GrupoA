...
public partial class content_module_tituloConteudoExtra_tituloConteudoExtraImagens : System.Web.UI.Page
{
    #region Propriedades
    ...
    void btnUploadFile_Click(object sender, EventArgs e)
    {
        if (ValidaArquivo())
        {
            ...
            this.ModuloTituloConteudoExtra();
    ...
    /// </summary>
    private void ModuloTituloConteudoExtra()
    {
    ...
    private TituloConteudoExtraArquivo InserirTituloConteudoExtraArquivo()
    {
        ...
        tituloConteudoExtraArquivo.NomeConteudo = txtNomeConteudo.Text;
        tituloConteudoExtraArquivo.RestritoProfessor = chkRestritoProfessor.Checked;
        tituloConteudoExtraArquivo.SomenteLogado = chkSomenteLogado.Checked;
