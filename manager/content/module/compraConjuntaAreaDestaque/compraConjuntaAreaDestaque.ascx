<%@ Control Language="C#" AutoEventWireup="true" CodeFile="compraConjuntaAreaDestaque.ascx.cs"
	Inherits="content_module_compraConjuntaAreaDestaque" %>
<%@ Register Src="../../../ctl/ag2RelacionarList.ascx" TagName="ag2RelacionarList"
	TagPrefix="uc1" %>
<asp:Label runat="server" ID="Label1" Font-Bold="true" Text="Nome da Página:"></asp:Label><br />
