<%@ Control Language="C#" AutoEventWireup="true" CodeFile="capituloImpresso.ascx.cs" Inherits="content_module_capituloImpresso_capituloImpresso" %>
<%@ Register src="../../../ctl/ag2RelacionarList.ascx" tagname="ag2RelacionarList" tagprefix="uc1" %>
<br />
<h3>Capítulo Impresso</h3>
<br />
